...
# post_divs = soup.find(class_="post__text").find_parents("div", "user__                                                                                                                                                 post")
# print(post_divs)
...
# .finda_next_sibling() .find_previous_sibling()
# next_sib = soup.find(class_="post__title").find_next_sibling()
# print(next_sib)

# prev_sib = soup.find(class_="post__date").find_previous_sibling().text
# print(prev_sib)
...
# find_a_by_text = soup.find("a", string="Clothes")
# print(find_a_by_text)

# find_a_by_text = soup.find("a", string="Clothes for women")
# print(find_a_by_text)

# find_a_by_text = soup.find("a", string=re.compile("Clothes"))
# print(find_a_by_text)

# find_all_clothes = soup.find_all(string=re.compile("([Cc]lothes)"))
