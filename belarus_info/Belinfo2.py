...
#     url = f"https://www.belarusinfo.by/ru/company/promyshlennost/bytovaya-himiya.html?limitstart={i}"
#
#     q = requests.get(url)
#     result = q.content
#
...
#         person_url_list_2.append(person_page_url)
#
# with open("person_url_list_2.txt", "a") as  file:
#     for line in person_url_list_2:
#         file.write(f"https://www.belarusinfo.by{line}\n")

# count = 0
#
# with open("person_url_list_2.txt") as file:
...
# #
#         with open(f"data_dict_2.csv", "a", encoding="utf-8") as file:
