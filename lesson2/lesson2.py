...
# # print(src)
#
# # with open('lesson2/index.html', 'w') as file:
# #     file.write(src)
#
...
#
# itetarion_count = int(len(all_categiries)) - 1
#
# count = 0
...
#     itetarion_count = itetarion_count - 1
#
#     if itetarion_count == 0:
#         print("Работа завершена")
#         break
#
#     print(f"Осталось итераций: {itetarion_count}")
